...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void UpdateCameraPosition(float speed)
    {
        ...
        {
            headObject.transform.localPosition = m_HeadBob.DoHeadBob(m_CharacterController.velocity.magnitude + (speed * (m_IsWalking ? 1f : m_RunstepLenghten)));
            newCameraPosition = headObject.transform.localPosition;
            newCameraPosition.y = headObject.transform.localPosition.y - m_JumpBob.Offset();
        }
        else
        {
            newCameraPosition = headObject.transform.localPosition;
        ...
        headObject.transform.localPosition = newCameraPosition;
    }
